...
public class Patient extends Person {
    ...
    public History getSickness() { return sickness; }
    public void setSickness(History sickness) { this.sickness = sickness; }
    ...
    public List<String> getSpecialReqs() { return specialReqs; }
    public void setSpecialReqs(List<String> specialReqs) { this.specialReqs = specialReqs; }
}
